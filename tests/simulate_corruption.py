...
(Fernet's own built-in authentication rejects tampered ciphertext)
rather than a hash mismatch, though either outcome demonstrates the
same thing: corrupted data doesn't silently pass through.
...
def do_handshake(sock):
    """Same handshake as sender.py - duplicated here since this script
    intentionally stands alone rather than importing sender.py."""
